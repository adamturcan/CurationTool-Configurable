 ...
 *
 * Overriding the repository also invalidates the application-service singleton, so the next `getWorkspaceApplicationService()` call rebuilds with the new repo. No manual cache busting needed.
 *
